...
public class PanelBotones extends JPanel implements ActionListener
{
	...
	public PanelBotones(InterfazLibreria interfazLibreria)
	{
		...
		agregarBoton(CALIFICACION, "Calificacion Promedio", "./data/iconos/estrella.png");
		agregarBoton(CATEGORIA_MAS_LIBROS, "Categoria con mas libros", "./data/iconos/libreria.png");
		agregarBoton(CONTAR_SIN_PORTADA, "libros sin portada", "./data/iconos/libro.png");
		agregarBoton(CATEGORIA_MEJOR, "categoria mejor calificada", "./data/iconos/premio.png");
		agregarBoton(AUTOR_VARIAS_CATEGORIAS, "autor de varias cates", "./data/iconos/autor.png");
		agregarBoton(RENOMBRAR_CATEGORIAS, "renombrar categorias", "./data/iconos/partdos.png");
		agregarBoton(BORRAR_LIBROS, "borrar libros", "./data/iconos/partres.png");
	}
