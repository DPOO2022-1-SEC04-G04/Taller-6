...
public class InterfazLibreria extends JFrame
{
	...
	public void renombrarCategoria() {
		String cate = JOptionPane.showInputDialog(this, "Escriba el nombre original de la categoria", "categoria");
		if (cate != null)
		{
			boolean esta = libreria.buscarCate(cate);
			if (esta)
			{
				String nueva = JOptionPane.showInputDialog(this, "Escriba el nuevo nombre de la categoria", "categoria");
				if (nueva != null)
				{
					try {
						libreria.cambiarCate(cate, nueva);
					} catch (Exception e) {
						// TODO Auto-generated catch block
						JOptionPane.showMessageDialog(this, "Categoriarepetida", "No hay categoria",
								JOptionPane.INFORMATION_MESSAGE);
					}
				}
			}
			...
			{
				JOptionPane.showMessageDialog(this, "No se encontro la categoria", "No hay categoria",
						JOptionPane.INFORMATION_MESSAGE);
				renombrarCategoria();
			}
		}
	...
	public void borrarLibros() {
		String linea = JOptionPane.showInputDialog(this, "Escriba el nombre de los autores separados por comas", "autor");
		if(linea != null)
		{
			try {
				int numero = libreria.borrarLibros(linea);
				JOptionPane.showMessageDialog(this, "Se borraron "+String.valueOf(numero)+" libros", "SI SE BORRARON",
						JOptionPane.INFORMATION_MESSAGE);
				this.panelLibros.actualizarLibros(this.libreria.darLibros());
			} catch (Exception e) {
				// TODO Auto-generated catch block
				JOptionPane.showMessageDialog(this, e.getMessage(), "NO SE BORRARON",
						JOptionPane.INFORMATION_MESSAGE);
			}
		}
